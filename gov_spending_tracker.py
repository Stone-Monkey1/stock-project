...
payload = {
    "filters": {
        ...
        "time_period": [{"start_date": start_date_str, "end_date": end_date_str}],
    },
...
if response.status_code == 200:
    ...
    if investable_df.empty:
        ...
        investable_df["Award Amount"] = investable_df["Award Amount"].apply(
            lambda x: f"${x:,.2f}"
        )
        print(
            investable_df[
                ["Ticker", "Recipient Name", "Award Amount", "Funding Agency"]
